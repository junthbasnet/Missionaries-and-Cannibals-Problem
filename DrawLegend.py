...
def draw_legend(graph):
    ...
    legend2 = pydot.Node("Killed State (KS)", shape="plaintext", fontname='Arsenal', fontsize="20")
    graphlegend.add_node(legend2)
    legend3 = pydot.Node('Node generating only ES', shape="plaintext", fontname='Arsenal', fontsize="20")
    graphlegend.add_node(legend3)
    legend4 = pydot.Node('Goal State (GS)', shape="plaintext", fontname='Arsenal', fontsize="20")
